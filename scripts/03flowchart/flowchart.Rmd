...
moji <- str_glue("<<content of flow chart>>\n[1]:'new text!'")
...
```{r}
#なぜなら、ただの\nを入れてしまうと、
moji2 <- str_glue("<<content of flow chart>>\n[1]:'new \n text'")
cat(moji2)
```
...
moji3 <- str_glue("<<content of flow chart>>\n[1]:'new \\n text'")
cat(moji3)
```
```{r}
#ほら！
...
```{r}
#atat_listに、次のようなデータを放り込むことを考えます。
